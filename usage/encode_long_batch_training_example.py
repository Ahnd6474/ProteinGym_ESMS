"""Train MLP on embeddings from encode_long_batch for long sequences."""
import random
import numpy as np
import torch
...
def random_long_sequences(n: int, length: int) -> list[str]:
...
def main() -> None:
    ...
    sequences = random_long_sequences(200, 800)
